...
const PageSection = (props) => {
  ...
  function updateDatasourceAfterFieldDragEnd(event) {
    ...
    if (active.id !== over.id) {
      let activeField = items.filter((field)=> field.editor_id === active.id )[0]
  ...
  return (
    <div ref={setNodeRef} style={style}>
      <div className="page-section-item form-item-header-container col-auto">
        <div>
          <button
            type="button"
          ...
          <Accordion.Item eventKey="0">
            ...
            <Accordion.Body>
              <div className="form-item-header-container">
                ...
                <div className="form-item-header-item col-auto">
